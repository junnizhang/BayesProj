...
#'
#' @seealso
#' - [fit_mod()] to fit a time series model.
#' - [Benchmarks()] to specify forecast benchmarks.
#'   time series model.
#' - [components()] for parameters from the projection.
#' - [augment()] for future values from the the projection,
#'   combined with the benchmarks.
#'
#' @export
project_ts <- function(mod,
                       spec_bench = NULL) {
