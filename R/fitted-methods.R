...
## HAS_TESTS
#' Obtain Smoothed Estimates, Combined with Original Data
#'
#' Extract smoothed values for indicator being
#' modelled in a call to [fit_ts()],
...
## HAS_TESTS
#' Extract Components from a Fitted Time Series Model
#'
